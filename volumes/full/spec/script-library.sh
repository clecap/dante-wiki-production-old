...
CREATE USER IF NOT EXISTS ${MY_DB_USER}@'172.21.0.3/255.0.0.0' IDENTIFIED BY '${MY_DB_PASS}';
GRANT ALL PRIVILEGES ON ${MY_DB_NAME}.* TO '${MY_DB_USER}'@'%';
GRANT ALL PRIVILEGES ON ${MY_DB_NAME}.* TO '${MY_DB_USER}'@'localhost';
GRANT ALL PRIVILEGES ON ${MY_DB_NAME}.* TO '${MY_DB_USER}'@'172.21.0.3/255.0.0.0';
FLUSH PRIVILEGES;
MYSQLSTUFF
